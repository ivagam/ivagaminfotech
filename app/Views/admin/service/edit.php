...
<div class="container mt-4">
    <h4>Edit Service</h4>
    <form method="post" action="<?= base_url('admin/service/update/' . $service->id) ?>" enctype="multipart/form-data">
        <div class="mb-3">
            <label>Title</label>
        ...
        <div class="mb-3">
            ...
            <img src="<?= base_url('public/uploads/' . $service->image) ?>" width="100"><br><br>
        ...
        <div class="mb-3">
            ...
            <textarea name="meta_keywords" class="form-control"><?= $service->meta_key ?></textarea>
        </div>
